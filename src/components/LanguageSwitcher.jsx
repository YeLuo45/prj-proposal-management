...
function LanguageSwitcher() {
  ...
  const dropdown = (
    <div
      className={`absolute ${direction === 'rtl' ? 'left-0' : 'right-0'} mt-2 py-2 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 min-w-[160px] z-50`}>
